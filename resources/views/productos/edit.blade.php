...
@section('content')
	...
	<input class="form-control" type="text" name="codigo" id="codigo-field" value="{{ old('codigo', $producto->codigo ) }}" />
</div> <div class="form-group">
	<label for="nombreproducto-field">Nombreproducto</label>
	<input class="form-control" type="text" name="nombreproducto" id="nombreproducto-field" value="{{ old('nombreproducto', $producto->nombreproducto ) }}" />
</div> <div class="form-group">
	<label for="descripcion-field">Descripcion</label>
	<input class="form-control" type="text" name="descripcion" id="descripcion-field" value="{{ old('descripcion', $producto->descripcion ) }}" />
</div> <div class="form-group">
